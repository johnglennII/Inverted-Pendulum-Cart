%% Linear Inverted Pendulum LQR/ LQI
clc;clear;close('all');

% Define constants/parameters
g = 9.81; % gravitational const (m/s^2)
mc = 666e-3; % cart mass (kg)
...
try
    ...
    myRunObj = Simulink.sdi.getCurrentSimulationRun("LQI_hardware");
...
if export_plt == 'y'
    ...
    mediaPath = fullfile(currentPath, '..', '..', 'media', 'LQR_LQI');
